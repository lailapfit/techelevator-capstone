	...
	<table>
		<tr>
			...
			<td><form:select path="parkCode">
				...
				</form:select> <form:errors path="parkCode"/></td>
		</tr>
		<tr>
		...
		<tr>
			<th><label for="activityLevel">Activity Level</label></th>

			<td><input name="activityLevel" type="radio" value="inactive">Inactive
				<input name="activityLevel" type="radio" value="sedentary">Sedentary
				<input name="activityLevel" type="radio" value="active">Active
				<input name="activityLevel" type="radio" value="extremelyActive">Extremely Active</td>
		</tr>
	</table>
